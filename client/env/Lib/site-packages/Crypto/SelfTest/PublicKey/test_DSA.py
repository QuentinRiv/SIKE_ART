...
"""Self-test suite for Crypto.public_keyey.DSA"""
...
class DSATest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from Crypto.public_keyey import DSA
    ...
    def _check_public_key(self, dsaObj):
        ...
        self.assertEqual(dsaObj.public_keyey() == dsaObj.public_keyey(),True) # assert_
        self.assertEqual(dsaObj.public_keyey() != dsaObj.public_keyey(),False) # failIf
