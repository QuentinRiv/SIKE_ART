...
"""Self-test suite for Crypto.public_keyey.RSA"""
...
class RSATest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from Crypto.public_keyey import RSA
    ...
    def _check_public_key(self, rsaObj):
        ...
        self.assertEqual(rsaObj.public_keyey() == rsaObj.public_keyey(),True) # assert_
        self.assertEqual(rsaObj.public_keyey() != rsaObj.public_keyey(),False) # failIf
