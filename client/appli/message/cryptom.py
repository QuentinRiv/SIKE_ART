...
from appli.info.mysike import eA, p, SIKE_compute_pk, server_address
from appli.info.mysike import Complex, convert_Complex, createSS

from appli.info.classes import Party
from appli.info.db_func import get_otk, get_priv_id, names_n_group
from appli.info.db_func import get_token, get_stagekey
...
def get_key_aes(sender, recipient, info_otk=None):
    ...
    if recipient in names:
        ...
        print('keyy = ', keyy)
        stage_key = get_stagekey(recipient)
